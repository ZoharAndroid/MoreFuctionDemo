...
public class AmapUtil {
     ...
     * 高德导航
     **/
    @SuppressLint("NewApi") public static void goToGaodeNaviActivity(Context context, String sourceApplication,
     ...
     */
    @SuppressLint("NewApi") public static void goToGaodeNaviActivity(Context context, String sourceApplication, String slat,
  ...
  startActivity(i1);*/
    @SuppressLint("NewApi") public static void goToBaiduNaviActivity(Context context, double originlat, double originlon,
     ...
     * @param toLon
     */
    @SuppressLint("NewApi") public static void goToTenCentNaviActivity(Context context, String type, String from,
    ...
    /**
     * 根据包名检测某个APP是否安装
     * @param packageName 包名  百度的包名为 com.baidu.BaiduMap，高德com.autonavi.minimap,腾讯com.tencent.map
     ...
     * @return
     */
    public static boolean isInstallBaiduMapByRead() {
        return new File("/data/data/" + "com.baidu.BaiduMap").exists();
    }

    public static boolean isInstallGaodeByRead() {
        return new File("/data/data/" + "com.autonavi.minimap").exists();
    }

    public static boolean isInstallTencentByRead() {
